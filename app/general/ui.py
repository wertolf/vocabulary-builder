...
from . import ExternalRuntimeData, RuntimeUnit
...
class _Focusable:
    ...
    @is_focused.setter
    def is_focused(self, value: bool) -> NoReturn: self._is_focused = value
...
class _Pressable:
    ...
    @is_pressed.setter
    def is_pressed(self, value: bool) -> NoReturn: self._is_pressed = value
...
class _Control(Sprite, _AbstractControl):
    ...
    def _update_rect(self) -> NoReturn: self._rect = self._get_rect()

    def _update_surf(self) -> NoReturn:
        self._surf = self._get_surf()
        self._update_rect()

    def blit_myself(self, target_surf: Surface) -> NoReturn:
    ...
    @bottom.setter
    def bottom(self, value: int) -> NoReturn:
        self.position_info["bottom"] = value
        self._update_rect()

    @centerx.setter
    def centerx(self, value: int) -> NoReturn:
        self.position_info["centerx"] = value
        self._update_rect()

    @centery.setter
    def centery(self, value: int) -> NoReturn:
        self.position_info["centery"] = value
        self._update_rect()

    @left.setter
    def left(self, value: int) -> NoReturn:
        self.position_info["left"] = value
        self._update_rect()

    @right.setter
    def right(self, value: int) -> NoReturn:
        self.position_info["right"] = value
        self._update_rect()

    @top.setter
    def top(self, value: int) -> NoReturn:
    ...
    @name.setter
    def name(self, value: str) -> NoReturn: self._name = value
...
class _Page:
    ...
    def do_sth_after_each_loop(self) -> NoReturn:
        self.handle_events()

    def do_sth_before_each_loop(self) -> NoReturn:
        pass

    def do_sth_before_main_loop_start(self) -> NoReturn:
    ...
    def draw_and_flip(self, **kwargs) -> NoReturn:
        self.draw()
        self.flip()
    ...
    def loop_once(self) -> NoReturn:  # 循环体，可以在Page的子类中自定义
        pass

    def register_controls(self, *controls: _Control) -> NoReturn:
        for c in controls:
            self.dict_of_controls[c.name] = c

    def register_events(self, *event_handlers) -> NoReturn:
    ...
    def update_a_local_control(self, c: _Control) -> NoReturn:
        c.blit_myself(self.screen)
        self.rtu.update_a_local_area_of_screen(c.rect)

    def update_local_controls(self, *controls: _Control) -> NoReturn:
        for c in controls:
    ...
    @ is_alive.setter
    def is_alive(self, value: bool) -> NoReturn: self._is_alive = value
...
class _TemporaryPage(_Page):
    ...
    def __init__(
            ...
            centerx: int = resolution_info.x_mean,
            centery: int = resolution_info.y_mean,
            window_height: int = resolution_info.temp_win_height,
            window_width: int = resolution_info.temp_win_width,
    ) -> NoReturn:
...
class _Button(_AbstractControl, _Focusable, _Pressable):
    ...
    @is_disabled.setter
    def is_disabled(self, value: bool) -> NoReturn: self._is_disabled = value
...
class _PageWithButtons(_Page):
    ...
    def on_mouse_button_down(self, e: EventType) -> NoReturn:
    ...
    def on_mouse_button_up(self, e: EventType) -> NoReturn:
    ...
    def on_mouse_motion(self, e: EventType) -> NoReturn:
    ...
    def current_focus(self, value: _LabelButton) -> NoReturn: self._current_focus = value
